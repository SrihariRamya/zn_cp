...
const BorderRadiusImg =
  'https://zupain-image.s3.ap-south-1.amazonaws.com/border-radius.png';

const BorderRadius = ({ setChangeType, setValue, activeElement, type }) => {
  const borderRadius =
    activeElement?.element[`${type}_style`]?.borderRadius || '0px 0px 0px 0px';
